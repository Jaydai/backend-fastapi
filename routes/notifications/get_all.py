...
async def get_all_notifications(
    ...
    try:
        ...
        if status_filter == "unread":
            ...
            notifications = NotificationService.get_unread_notifications(request.state.supabase_client, user_id)
        elif status_filter is None:
            logger.info(f"User {user_id} getting all notifications")
            notifications = NotificationService.get_all_notifications(request.state.supabase_client, user_id)
        else:
            raise HTTPException(
