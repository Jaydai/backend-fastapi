...
async def get_organization_teams(request: Request, organization_id: str) -> OrganizationTeamsResponseDTO:
    ...
    try:
        ...
        teams = TeamService.get_organization_teams(request.state.supabase_client, organization_id)
        ...
        raise HTTPException(status_code=500, detail=f"Failed to fetch organization teams: {str(e)}")
