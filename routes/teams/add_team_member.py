...
async def add_team_member(request: Request, team_id: str, body: AddTeamMemberRequestDTO) -> MemberAddedResponseDTO:
    """Add a user to a team"""
    try:
        member = TeamService.add_user_to_team(request.state.supabase_client, team_id, body.user_id, body.role)
