...
async def create_team(request: Request, organization_id: str, body: CreateTeamRequestDTO) -> TeamCreatedResponseDTO:
    ...
    try:
        ...
        team = TeamService.create_team(
            request.state.supabase_client, organization_id, body.name, body.description, body.parent_team_id, body.color
        )
