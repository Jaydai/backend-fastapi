"""Intent distribution endpoint for time-series analytics"""

import logging

from fastapi import HTTPException, Query, Request

from dtos.audit_dto import IntentTimelineResponseDTO
...
@router.get("/organizations/{organization_id}/intent-distribution", response_model=IntentTimelineResponseDTO)
