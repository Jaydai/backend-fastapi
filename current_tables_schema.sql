...
COMMENT ON COLUMN "public"."users_metadata"."onboarding_step" IS 'Current step in onboarding flow: not_started, flow_selection, org_details, org_billing, org_invite, personal_questions, extension_check, completed';



COMMENT ON COLUMN "public"."users_metadata"."onboarding_flow_type" IS 'Type of onboarding flow: invited (via invitation), create_org (creating new org), personal (personal account only)';



COMMENT ON COLUMN "public"."users_metadata"."onboarding_completed_at" IS 'Timestamp when user completed onboarding';



COMMENT ON COLUMN "public"."users_metadata"."extension_installed" IS 'Whether user has installed the Chrome extension';
...
CREATE INDEX "idx_users_metadata_onboarding_step" ON "public"."users_metadata" USING "btree" ("onboarding_step");
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."organizations" FOR INSERT WITH CHECK (true);
